...
// UNIFORMS
var lightPosition = {type: 'v3', value: new THREE.Vector3(0.5,0.5,-0.5)};
var rainbowLightPosition = {type: 'v3', value: new THREE.Vector3(-0.5,-0.5,-0.5)};

// MATERIALS
var armadilloMaterial = new THREE.ShaderMaterial({
  uniforms: {
    lightPosition: lightPosition,
    rainbowLightPosition: rainbowLightPosition,
  },
});
...
var rainbowLightbulbMaterial = new THREE.ShaderMaterial({
   uniforms: {
    rainbowLightPosition: rainbowLightPosition,
  },
});
...
var shaderFiles = [
  ...
  'glsl/rainbowLightbulb.vs.glsl',
  'glsl/rainbowLightbulb.fs.glsl'
];
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  rainbowLightbulbMaterial.vertexShader = shaders['glsl/rainbowLightbulb.vs.glsl'];
  rainbowLightbulbMaterial.fragmentShader = shaders['glsl/rainbowLightbulb.fs.glsl'];
})
...
// CREATE rainbow lightbulb
var rainbowLightbulbGeometry = new THREE.SphereGeometry(0.3, 32, 32);
var rainbowLightbulb = new THREE.Mesh(rainbowLightbulbGeometry, rainbowLightbulbMaterial);
rainbowLightbulb.parent = worldFrame;
scene.add(rainbowLightbulb);
